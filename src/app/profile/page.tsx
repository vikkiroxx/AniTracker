...
import { GET_VIEWER, GET_USER_PROFILE } from "@/lib/api/queries";
import { redirect } from "next/navigation";
import Image from "next/image";
import { User, PlayCircle, Clock, Hash, LogOut } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 -mt-20 relative z-10">
        <div className="flex flex-col md:flex-row items-center md:items-end gap-6 mb-8">
          ...
          <form action="/api/auth/logout" method="POST" className="mb-2">
            <button type="submit" className="flex items-center gap-2 px-4 py-2 bg-destructive/10 hover:bg-destructive/20 text-destructive rounded-full font-medium transition-colors">
